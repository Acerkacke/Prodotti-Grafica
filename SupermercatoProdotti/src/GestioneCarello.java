...
public class GestioneCarello {
	...
	protected void createContents() {
		...
		textCodiceNonAlimentare.setBackground(SWTResourceManager.getColor(SWT.COLOR_TITLE_INACTIVE_BACKGROUND_GRADIENT));
		...
		textPrezzoNonAlimentare.setBackground(SWTResourceManager.getColor(SWT.COLOR_TITLE_INACTIVE_BACKGROUND_GRADIENT));
